   ...
   <div>
    <Navbar />
      ...
      <span className='nav-bottom'> 
        <a className='bottom-links'><HomeOutlinedIcon fontSize="small"/> Home <ArrowForwardIosIcon fontSize="small"/> </a> 
        <a className='bottom-links'>Electronics <ArrowForwardIosIcon fontSize="small"/> </a>
        <a className='bottom-links'>Phones and Smart watches<ArrowForwardIosIcon fontSize="small"/></a> 
